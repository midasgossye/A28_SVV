...
q_b1 = [0]
q_open_b_1 = -S_zprime/I_zprimezprime*sum(B_i_arr[1]*z_y_angle_coords[1][0])-S_yprime/I_yprimeyprime*sum(B_i_arr[1]*z_y_angle_coords[1][1])
...
q_b2 = [0]
q_open_b_9 = -S_zprime/I_zprimezprime*sum(B_i_arr[9]*z_y_angle_coords[9][0])-S_yprime/I_yprimeyprime*sum(B_i_arr[9]*z_y_angle_coords[9][1])
q_open_b_9 = q_b2[0]+q_open_b_9
q_b2.append(q_open_b_9)   
q_open_b_7 = -S_zprime/I_zprimezprime*sum(B_i_arr[7]*z_y_angle_coords[7][0])-S_yprime/I_yprimeyprime*sum(B_i_arr[7]*z_y_angle_coords[7][1])
q_open_b_7 = q_b2[1]+q_open_b_7
q_b2.append(q_open_b_7)
q_open_b_5 = -S_zprime/I_zprimezprime*sum(B_i_arr[5]*z_y_angle_coords[5][0])-S_yprime/I_yprimeyprime*sum(B_i_arr[5]*z_y_angle_coords[5][1])
q_open_b_5  = q_b2[2]+q_open_b_5 
q_b2.append(q_open_b_5)
q_open_b_3  = -S_zprime/I_zprimezprime*sum(B_i_arr[3]*z_y_angle_coords[3][0])-S_yprime/I_yprimeyprime*sum(B_i_arr[3]*z_y_angle_coords[3][1])
...
q_b3 = q_b_atspar1 -S_zprime/I_zprimezprime*sum(B_spar_end*z_y_angle_coords[1][0])-S_yprime/I_yprimeyprime*sum(B_spar_end*z_y_angle_coords[1][1])

#Starting at the trailing edge of the cross-section and going along the bottom side of the cross-section
q_b4 = [0]
q_open_b_10 = -S_zprime/I_zprimezprime*sum(B_i_arr[10]*z_y_angle_coords[10][0])-S_yprime/I_yprimeyprime*sum(B_i_arr[10]*z_y_angle_coords[10][1])
q_open_b_10 = q_b4[0]+q_open_b_10
q_b2.append(q_open_b_10)   
q_open_b_8 = -S_zprime/I_zprimezprime*sum(B_i_arr[8]*z_y_angle_coords[8][0])-S_yprime/I_yprimeyprime*sum(B_i_arr[8]*z_y_angle_coords[8][1])
q_open_b_8 = q_b4[1]+q_open_b_8
q_b2.append(q_open_b_8)
q_open_b_6 = -S_zprime/I_zprimezprime*sum(B_i_arr[6]*z_y_angle_coords[6][0])-S_yprime/I_yprimeyprime*sum(B_i_arr[6]*z_y_angle_coords[6][1])
q_open_b_6  = q_b4[2]+q_open_b_6
q_b2.append(q_open_b_6)
q_open_b_4  = -S_zprime/I_zprimezprime*sum(B_i_arr[4]*z_y_angle_coords[4][0])-S_yprime/I_yprimeyprime*sum(B_i_arr[4]*z_y_angle_coords[4][1])
q_open_b_4  = q_b4[3]+q_open_b_4
q_b2.append(q_open_b_4)
...
q_b5 = []
q_open_afterspar2 = -S_zprime/I_zprimezprime*sum(B_spar_end*z_y_angle_coords[4][0])-S_yprime/I_yprimeyprime*sum(B_spar_end*z_y_angle_coords[4][1])
q_open_afterspar2 = q_b_atspar2 + q_open_afterspar2
q_b5.append(q_open_afterspar2)
q_open_b_2 = -S_zprime/I_zprimezprime*sum(B_i_arr[2]*z_y_angle_coords[2][0])-S_yprime/I_yprimeyprime*sum(B_i_arr[2]*z_y_angle_coords[2][1])
q_open_b_2 = q_b5[0]+q_open_b_2
q_b5.append(q_open_b_2)

#make a list of all the shearflows
q_basicshear = [q_b1[0], q_b1[1], q_b2[0], q_b2[1], q_b2[2], q_b2[3], q_b2[4], q_b3, q_b4[0], q_b4[1], q_b4[2], q_b4[3], q_b4[4], q_b5[0], q_b5[1]]
...
correctional1 = (1/(2*A_1*G)* (1/t_skin*(lengths[7]+ lengths[8]+ lengths[5]+ lengths[6])+ 1/t_spar*lengths[13])- 1/(2*A_2*G)*  (1/t_spar* lengths[14]))
correctional2 = 1/(2*A_1*G)* 1/t_spar*(lengths[13])+ (1/(2*A_2*G)* 1/t_skin*((lengths[12]+  lengths[11] +  lengths[10] +  lengths[9] + lengths[4] + lengths[3] + lengths[2] + lengths[1]) + (1/t_spar*lengths[14])))
twistrightside = 1/(2*A_2*G)* (1/t_skin*(-q_basicshear[5]* lengths[12]+ -q_basicshear[4]* lengths[11] + -q_basicshear[3]* lengths[10] + -q_basicshear[2]* lengths[9] + q_basicshear[12]*lengths[4] + q_basicshear[11]*lengths[3] + q_basicshear[10]*lengths[2] + q_basicshear[9]*lengths[1]) + (1/t_spar*-q_basicshear[7]* lengths[14])) 
-1/(2*A_1*G)* ((1/t_skin* (q_basicshear[0]* lengths[7]+q_basicshear[1]* lengths[8]+q_basicshear[13]* lengths[5]+q_basicshear[14]* lengths[6])) +1/t_spar*(q_basicshear[8]*lengths[13]))
momentrightside = q_basicshear[9]*lengths[1]*(cos(phi)*-z_y_angle_coords[10][2]+sin(phi)*-z_y_angle_coords[10][1]) + q_basicshear[10]*lengths[2]*(cos(phi)*-z_y_angle_coords[8][2]+sin(phi)*-z_y_angle_coords[8][1])+q_basicshear[11]*lengths[3]*(cos(phi)*-z_y_angle_coords[6][2]+sin(phi)*-z_y_angle_coords[6][1])+q_basicshear[12]*lengths[4]*(cos(phi)*-z_y_angle_coords[4][2]+sin(phi)*-z_y_angle_coords[4][1]) + q_basicshear[13]*lengths[5]*(h/2) + q_basicshear[14]*lengths[6]*(h/2) + q_basicshear[0]*lengths[7]*(h/2) + q_basicshear[1]*lengths[8]*(h/2) +  q_basicshear[2]*lengths[9]*(-cos(phi)*z_y_angle_coords[3][2]+sin(phi)*z_y_angle_coords[3][1]) + q_basicshear[3]*lengths[10]*(-cos(phi)*z_y_angle_coords[5][2]+sin(phi)*z_y_angle_coords[5][1]) + q_basicshear[4]*lengths[11]*(-cos(phi)*z_y_angle_coords[7][2]+sin(phi)*z_y_angle_coords[7][1]) + q_basicshear[5]*lengths[12]*(-cos(phi)*z_y_angle_coords[9][2]+sin(phi)*z_y_angle_coords[9][1])                          
