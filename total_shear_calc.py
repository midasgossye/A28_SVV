...
def totalshear(z_y_angle_coords, S_zprime, S_yprime, B_i_arr, B_spar_end, I_zprimezprime, I_yprimeyprime):
    ...
    for n in range(len(z_y_angle_coords)):
        z_coord_centeroid = z_y_angle_coords[n][0] - 0.0796889498
        z_y_centeroid.append((z_coord_centeroid, z_y_angle_coords[n][1], z_y_angle_coords[n][2]))
    ...
    q_ribs_right = Rib_force / h  # N/m
    q_ribs = [q_ribs_left, q_ribs_right]
